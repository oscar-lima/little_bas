...
void loop()
{
	...
	//compute motor angular speed in ticks / 0.25 sec
		...
		ticksA_backup.data = 15.5;
		ticksB_backup.data = 16.5;
		//reset ticks
		encoder_ticksA = 0;
		encoder_ticksB = 0;
	...
	//P controller
		//compute error
		errorA = set_pointA - angular_speedA;
		errorB = set_pointB - angular_speedB;
		pwm_duty_cycle_valueA = (int)(kp * errorA);
		pwm_duty_cycle_valueB = (int)(kp * errorB);
	...
	nh.spinOnce();
	//ROS needs some time to process the information
	delay(10);
}
